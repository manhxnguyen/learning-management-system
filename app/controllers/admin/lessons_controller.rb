class Admin::LessonsController < AdminController
  ...
  def update
    if @admin_lesson.update(lesson_params)
      redirect_to admin_course_lessons_path(@admin_course), notice: "Lesson was successfully updated.", status: :see_other
    else
  ...
  def destroy
    ...
    redirect_to admin_course_lessons_path(@admin_course), notice: "Lesson was successfully destroyed.", status: :see_other
  end
  ...
  def move
    ...
    elsif position == @admin_course.lessons.size - 1
